/* ============================================================
   Ambient aurora — softly drifting brand-color orbs behind a
   section. Ported from the 21st.dev "ambient-aurora" canvas to
   plain JS, scoped to each .nl-aurora host (not the window),
   tuned subtle so text stays readable.
   Runs only while on screen; static single frame for reduced motion.
   Supports multiple .nl-aurora hosts on the page.
   ============================================================ */
(function () {
  "use strict";
  ...
  document.querySelectorAll(".nl-aurora").forEach(initAurora);
})();
